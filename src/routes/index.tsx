				...
				<div className="max-w-7xl mx-auto relative z-10">
					...
					>
						...
						<h1 className="text-5xl md:text-7xl font-bold font-display tracking-tight mb-6 leading-tight">
							...
							<span className="text-gradient">AI-Powered</span> Interior Design
						</h1>
			...
			<section className="py-24 px-6 bg-muted/30">
				<div className="max-w-7xl mx-auto">
					...
					>
						...
						<p className="text-lg text-muted-foreground max-w-2xl mx-auto">
							Transform any space from concept to photorealistic render in
							minutes.
						</p>
					</motion.div>
						...
						{techStack.map((tech, index) => (
							...
							>
								<div className="flex items-start gap-4">
									<div
										className={`w-12 h-12 rounded-xl ${tech.bgColor} flex items-center justify-center shrink-0`}
									>
						...
						<div className="relative px-8 py-12 md:px-12 md:py-16 flex flex-col md:flex-row items-center gap-8">
							<div className="flex-1">
								...
								<p className="text-muted-foreground leading-relaxed mb-6 max-w-xl">
									This project was built during the Prisma Hackathon, showcasing
									the power of Prisma ORM and Prisma DB combined with TanStack
									Start, better-auth, and Vercel AI SDK for a complete
...
const steps = [
	{
		...
		description:
			"Start by uploading your floor plan as an image or PDF. Our AI analyzes the space and extracts accurate dimensions.",
	},
	{
		icon: Camera,
		title: "Add Room Photos",
		description:
			"Snap or upload photos of the rooms you want to renovate. AI maps them to your floor plan automatically.",
	},
	{
		icon: Sparkles,
		title: "Generate Designs",
		description:
			"Describe your vision and watch AI generate photorealistic renders, 3D models, and walkthrough videos.",
	},
];
...
const techStack = [
	{
		name: "TanStack Start",
		description:
			"Full-stack React framework with file-based routing and server functions.",
		icon: Zap,
	...
	},
	{
		name: "Prisma ORM",
		description:
			"Type-safe database client for seamless data modeling and queries.",
		icon: Database,
	...
	},
	{
		name: "Prisma DB",
		description:
			"Managed PostgreSQL database with automatic scaling and backups.",
		icon: Boxes,
	...
	},
	{
		name: "Better-auth",
		description:
			"Modern authentication library with OAuth, magic links, and more.",
		icon: Shield,
	...
	},
	{
		...
		description:
			"Agent mode for intelligent AI workflows and tool orchestration.",
		icon: Bot,
	...
	},
	{
		...
		description:
			"Model Context Protocol for AI-powered image and 3D generation.",
		icon: Image,
